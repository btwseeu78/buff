...
// 	protoc        (unknown)
// source: pet/v1/petservice.proto
...
func (PetType) Descriptor() protoreflect.EnumDescriptor {
	return file_pet_v1_petservice_proto_enumTypes[0].Descriptor()
}

func (PetType) Type() protoreflect.EnumType {
	return &file_pet_v1_petservice_proto_enumTypes[0]
}
...
func (PetType) EnumDescriptor() ([]byte, []int) {
	return file_pet_v1_petservice_proto_rawDescGZIP(), []int{0}
}
...
func (x *Pet) Reset() {
	*x = Pet{}
	mi := &file_pet_v1_petservice_proto_msgTypes[0]
...
func (x *GetPetRequest) Reset() {
	*x = GetPetRequest{}
	mi := &file_pet_v1_petservice_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetPetRequest) Descriptor() ([]byte, []int) {
	return file_pet_v1_petservice_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetPetResponse) Reset() {
	*x = GetPetResponse{}
	mi := &file_pet_v1_petservice_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetPetResponse) Descriptor() ([]byte, []int) {
	return file_pet_v1_petservice_proto_rawDescGZIP(), []int{2}
}
...
func (x *PutPetRequest) Reset() {
	*x = PutPetRequest{}
	mi := &file_pet_v1_petservice_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PutPetRequest) Descriptor() ([]byte, []int) {
	return file_pet_v1_petservice_proto_rawDescGZIP(), []int{3}
}
...
func (x *PutPetResponse) Reset() {
	*x = PutPetResponse{}
	mi := &file_pet_v1_petservice_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PutPetResponse) Descriptor() ([]byte, []int) {
	return file_pet_v1_petservice_proto_rawDescGZIP(), []int{4}
}
...
func (x *DeletePetRequest) Reset() {
	*x = DeletePetRequest{}
	mi := &file_pet_v1_petservice_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeletePetRequest) Descriptor() ([]byte, []int) {
	return file_pet_v1_petservice_proto_rawDescGZIP(), []int{5}
}
...
func (x *DeletePetResponse) Reset() {
	*x = DeletePetResponse{}
	mi := &file_pet_v1_petservice_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeletePetResponse) Descriptor() ([]byte, []int) {
	return file_pet_v1_petservice_proto_rawDescGZIP(), []int{6}
}

var File_pet_v1_petservice_proto protoreflect.FileDescriptor

const file_pet_v1_petservice_proto_rawDesc = "" +
	"\n" +
	"\x17pet/v1/petservice.proto\x12\x06pet.v1\x1a\x1agoogle/type/datetime.proto\x1a\x1bbuf/validate/validate.proto\"\x92\x01\n" +
	"\x03Pet\x12*\n" +
	...
	"\rGetPetRequest\x12\x1d\n" +
	"\x06pet_id\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x05petId\"/\n" +
...
var (
	...
	file_pet_v1_petservice_proto_rawDescData []byte
)

func file_pet_v1_petservice_proto_rawDescGZIP() []byte {
	file_pet_v1_petservice_proto_rawDescOnce.Do(func() {
		file_pet_v1_petservice_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pet_v1_petservice_proto_rawDesc), len(file_pet_v1_petservice_proto_rawDesc)))
	})
	return file_pet_v1_petservice_proto_rawDescData
}

var file_pet_v1_petservice_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pet_v1_petservice_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_pet_v1_petservice_proto_goTypes = []any{
...
func init() { file_pet_v1_petservice_proto_init() }
func file_pet_v1_petservice_proto_init() {
	if File_pet_v1_petservice_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pet_v1_petservice_proto_rawDesc), len(file_pet_v1_petservice_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_pet_v1_petservice_proto_goTypes,
		DependencyIndexes: file_pet_v1_petservice_proto_depIdxs,
		EnumInfos:         file_pet_v1_petservice_proto_enumTypes,
		MessageInfos:      file_pet_v1_petservice_proto_msgTypes,
	}.Build()
	File_pet_v1_petservice_proto = out.File
	file_pet_v1_petservice_proto_goTypes = nil
	file_pet_v1_petservice_proto_depIdxs = nil
}
